...
export default async function handler(req, res) {
    ...
    try {
        ...
        if (useDuoMode && message) {
            ...
            return res.status(200).json({ round1: duoResults, round2: round2Results, verdict });
            ...
            return res.status(200).json({ round1: round1Results, round2: round2Results, verdict });
            ...
            return res.status(200).json({ responses, verdict });
        }
    } catch (error) {
